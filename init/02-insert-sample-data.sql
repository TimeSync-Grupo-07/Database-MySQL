...
-- -- =========================
-- -- Inserir dados na tabela usuarios (COM CRIPTOGRAFIA)
-- -- =========================
-- INSERT INTO usuarios (
--     matricula, nome_completo_usuario, 
--     email_usuario_criptografado, 
--     id_microsoft_usuario_criptografado, 
--     data_criacao_usuario, data_atualizacao_usuario, 
--     id_estado_dado, matricula_superior
-- ) VALUES
-- (509880, 'Giovanna AAvila', 
--  AES_ENCRYPT('giovanna.aavila@empresa.com', 'timesync_chave_criptografia_2025'),
--  AES_ENCRYPT('giovanna.aavila_empresa.com#EXT#', 'timesync_chave_criptografia_2025'),
--  NOW(), NOW(), 
--  (SELECT id_estado_dado FROM estado_dados WHERE nome_estado_dado = 'Ativo' LIMIT 1), NULL),

-- (509881, 'Carlos Silva', 
--  AES_ENCRYPT('carlos.silva@empresa.com', 'timesync_chave_criptografia_2025'),
--  AES_ENCRYPT('carlos.silva_empresa.com#EXT#', 'timesync_chave_criptografia_2025'),
--  NOW(), NOW(), 
--  (SELECT id_estado_dado FROM estado_dados WHERE nome_estado_dado = 'Ativo' LIMIT 1), 509880),

-- (509882, 'Ana Rodrigues', 
--  AES_ENCRYPT('ana.rodrigues@empresa.com', 'timesync_chave_criptografia_2025'),
--  AES_ENCRYPT('ana.rodrigues_empresa.com#EXT#', 'timesync_chave_criptografia_2025'),
--  NOW(), NOW(), 
--  (SELECT id_estado_dado FROM estado_dados WHERE nome_estado_dado = 'Ativo' LIMIT 1), 509880),

-- (509883, 'Pedro Santos', 
--  AES_ENCRYPT('pedro.santos@empresa.com', 'timesync_chave_criptografia_2025'),
--  AES_ENCRYPT('pedro.santos_empresa.com#EXT#', 'timesync_chave_criptografia_2025'),
--  NOW(), NOW(), 
--  (SELECT id_estado_dado FROM estado_dados WHERE nome_estado_dado = 'Ativo' LIMIT 1), 509880),

-- (509884, 'Mariana Lima', 
--  AES_ENCRYPT('mariana.lima@empresa.com', 'timesync_chave_criptografia_2025'),
--  AES_ENCRYPT('mariana.lima_empresa.com#EXT#', 'timesync_chave_criptografia_2025'),
--  NOW(), NOW(), 
--  (SELECT id_estado_dado FROM estado_dados WHERE nome_estado_dado = 'Ativo' LIMIT 1), 509880);
...
-- =========================
-- Inserir dados na tabela assoc_cargo_equipe (COM CRIPTOGRAFIA)
-- =========================
-- INSERT INTO assoc_cargo_equipe (
--     id_assoc_cargo_equipe, usuarios_matricula, equipe_id_equipe, 
--     cargo_usuario_id_cargo_usuario, valor_hora_criptografado
-- ) VALUES
-- (UUID_TO_BIN(UUID()), 509880, (SELECT id_equipe FROM equipe WHERE usuarios_matricula = 509880),
--  (SELECT id_cargo_usuario FROM cargo_usuario WHERE titulo_cargo_usuario = 'Especialista em Automação'), 
--  AES_ENCRYPT('150.00', 'timesync_chave_criptografia_2025')),

-- (UUID_TO_BIN(UUID()), 509881, (SELECT id_equipe FROM equipe WHERE usuarios_matricula = 509880),
--  (SELECT id_cargo_usuario FROM cargo_usuario WHERE titulo_cargo_usuario = 'Desenvolvedor RPA'), 
--  AES_ENCRYPT('120.00', 'timesync_chave_criptografia_2025')),

-- (UUID_TO_BIN(UUID()), 509882, (SELECT id_equipe FROM equipe WHERE usuarios_matricula = 509880),
--  (SELECT id_cargo_usuario FROM cargo_usuario WHERE titulo_cargo_usuario = 'Analista de Processos'), 
--  AES_ENCRYPT('100.00', 'timesync_chave_criptografia_2025')),

-- (UUID_TO_BIN(UUID()), 509883, (SELECT id_equipe FROM equipe WHERE usuarios_matricula = 509880),
--  (SELECT id_cargo_usuario FROM cargo_usuario WHERE titulo_cargo_usuario = 'Desenvolvedor RPA'), 
--  AES_ENCRYPT('110.00', 'timesync_chave_criptografia_2025')),

-- (UUID_TO_BIN(UUID()), 509884, (SELECT id_equipe FROM equipe WHERE usuarios_matricula = 509880),
--  (SELECT id_cargo_usuario FROM cargo_usuario WHERE titulo_cargo_usuario = 'Coordenador de Projetos'), 
--  AES_ENCRYPT('130.00', 'timesync_chave_criptografia_2025'));
